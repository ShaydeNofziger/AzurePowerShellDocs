...
Please consult Traffic Manager documentation for a full list of accepted values (https://docs.microsoft.com/azure/traffic-manager/traffic-manager-geographic-regions).
