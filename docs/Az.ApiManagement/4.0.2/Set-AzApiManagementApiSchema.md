...
### -ResourceId
Arm ResourceId of Diagnostic or Api Schema.
This parameter is required.
...
### -SchemaDocument
Api schema document as a string.
This parameter is required is -SchemaDocumentFile is not specified.
...
Api schema document file path.
This parameter is required is -SchemaDocument is not specified.
