...
### -BackendProtocol
Backend Security protocol settings.
This parameter is optional.
The valid Protocol Settings are  \`Tls11\` - Tls 1.1 \`Tls10\` - Tls 1.0 \`Ssl30\` - SSL 3.0
...
### -CipherSuite
Ssl cipher suites settings in the specified order.
This parameter is optional.
The valid Settings are  \`TripleDes168\` - Enable / Disable Tripe Des 168
...
### -FrontendProtocol
Frontend Security protocols settings.
This parameter is optional.
The valid Protocol Settings are  \`Tls11\` - Tls 1.1 \`Tls10\` - Tls 1.0 \`Ssl30\` - SSL 3.0
...
### -ServerProtocol
Server protocol settings like Http2.
This parameter is optional.
The valid Settings are  \`Http2\` - Enable Http 2.0
