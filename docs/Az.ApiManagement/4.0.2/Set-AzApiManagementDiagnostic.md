...
### -BackendSetting
Diagnostic setting for incoming/outgoing Http Messages to the Backend.
This parameter is optional.
...
### -FrontEndSetting
Diagnostic setting for incoming/outgoing Http Messages to the Gateway.
This parameter is optional.
...
### -ResourceId
Arm ResourceId of Diagnostic or Api Diagnostic.
This parameter is required.
