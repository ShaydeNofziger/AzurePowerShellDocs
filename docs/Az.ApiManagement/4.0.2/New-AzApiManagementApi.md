...
New-AzApiManagementApi -Context <PsApiManagementContext> [-ApiId <String>] -Name <String>
 ...
 [-SourceApiRevision <String>] [-ApiType <String>] [-TermsOfServiceUrl <String>] [-ContactName <String>]
...
This command creates an API \`echoapiv3\` in ApiVersionSet \`xmsVersionSet\` and copies all operation, Tags and Policies from source Api \`echo-api\`.
...
### -SourceApiRevision
Api Revision of the source API.
This parameter is optional.
