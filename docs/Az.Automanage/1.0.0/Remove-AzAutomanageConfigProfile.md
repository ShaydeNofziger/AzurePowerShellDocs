...
### DeleteViaIdentity
```
Remove-AzAutomanageConfigProfile -InputObject <IAutomanageIdentity> [-DefaultProfile <PSObject>] [-Break]
...
[https://learn.microsoft.com/powershell/module/az.automanage/remove-azautomanageconfigprofile](https://learn.microsoft.com/powershell/module/az.automanage/remove-azautomanageconfigprofile)
