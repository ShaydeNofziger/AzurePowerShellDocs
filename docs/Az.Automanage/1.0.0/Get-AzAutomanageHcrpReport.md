...
### GetViaIdentity
```
Get-AzAutomanageHcrpReport -InputObject <IAutomanageIdentity> [-DefaultProfile <PSObject>] [-Break]
...
[https://learn.microsoft.com/powershell/module/az.automanage/get-azautomanagehcrpreport](https://learn.microsoft.com/powershell/module/az.automanage/get-azautomanagehcrpreport)
