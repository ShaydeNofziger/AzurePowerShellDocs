...
### List2 (Default)
```
Get-AzAutomanageConfigProfileAssignment [-SubscriptionId <String[]>] [-DefaultProfile <PSObject>] [-Break]
...
Get-AzAutomanageConfigProfileAssignment -ResourceGroupName <String> [-SubscriptionId <String[]>]
 -ClusterName <String> [-DefaultProfile <PSObject>] [-Break] [-HttpPipelineAppend <SendAsyncStep[]>]
...
```
Get-AzAutomanageConfigProfileAssignment -ResourceGroupName <String> [-SubscriptionId <String[]>]
 -VMName <String> [-DefaultProfile <PSObject>] [-Break] [-HttpPipelineAppend <SendAsyncStep[]>]
 [-HttpPipelinePrepend <SendAsyncStep[]>] [-Proxy <Uri>] [-ProxyCredential <PSCredential>]
 [-ProxyUseDefaultCredentials] [<CommonParameters>]
```
...
[https://learn.microsoft.com/powershell/module/az.automanage/get-azautomanageconfigprofileassignment](https://learn.microsoft.com/powershell/module/az.automanage/get-azautomanageconfigprofileassignment)
