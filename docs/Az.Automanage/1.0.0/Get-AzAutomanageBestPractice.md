...
### List (Default)
```
Get-AzAutomanageBestPractice [-DefaultProfile <PSObject>] [-Break] [-HttpPipelineAppend <SendAsyncStep[]>]
...
### Get
```
Get-AzAutomanageBestPractice -Name <String> [-DefaultProfile <PSObject>] [-Break]
...
[https://learn.microsoft.com/powershell/module/az.automanage/get-azautomanagebestpractice](https://learn.microsoft.com/powershell/module/az.automanage/get-azautomanagebestpractice)
