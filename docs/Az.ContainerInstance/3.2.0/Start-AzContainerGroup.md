...
### StartViaIdentity
```
Start-AzContainerGroup -InputObject <IContainerInstanceIdentity> [-DefaultProfile <PSObject>] [-AsJob] [-Break]
...
[https://learn.microsoft.com/powershell/module/az.containerinstance/start-azcontainergroup](https://learn.microsoft.com/powershell/module/az.containerinstance/start-azcontainergroup)
