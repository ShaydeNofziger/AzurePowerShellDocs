...
Set-AzDataFactoryV2IntegrationRuntime [-ResourceGroupName] <String> [-DataFactoryName] <String>
 ...
 [-Edition <String>] [-VNetInjectionMethod <String>] [-ExpressCustomSetup <ArrayList>]
...
The cmdlet adds the ADF to use the shared integration runtime.
When using \`-SharedIntegrationRuntimeResourceId\` parameter the \`-Type\` must also be included.
Note that the data factory need to be granted permission to use the integration runtime before running cmdlet.
