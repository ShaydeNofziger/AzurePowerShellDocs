...
### DeleteViaIdentity
```
Remove-AzDatabricksWorkspace -InputObject <IDatabricksIdentity> [-DefaultProfile <PSObject>] [-AsJob] [-Break]
...
[https://learn.microsoft.com/powershell/module/az.databricks/remove-azdatabricksworkspace](https://learn.microsoft.com/powershell/module/az.databricks/remove-azdatabricksworkspace)
