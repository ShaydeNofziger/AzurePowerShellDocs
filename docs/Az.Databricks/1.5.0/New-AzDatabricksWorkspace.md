...
New-AzDatabricksWorkspace -Name <String> -ResourceGroupName <String> [-SubscriptionId <String>]
 -Location <String> [-ManagedResourceGroupName <String>] [-AmlWorkspaceId <String>] [-EnableNoPublicIP]
 ...
 [-PublicNetworkAccess <PublicNetworkAccess>] [-PublicSubnetName <String>] [-RequireInfrastructureEncryption]
 [-RequiredNsgRule <RequiredNsgRules>] [-Sku <String>] [-SkuTier <String>] [-StorageAccountName <String>]
 [-StorageAccountSku <String>] [-Tag <Hashtable>] [-VirtualNetworkId <String>] [-VnetAddressPrefix <String>]
...
[https://learn.microsoft.com/powershell/module/az.databricks/new-azdatabricksworkspace](https://learn.microsoft.com/powershell/module/az.databricks/new-azdatabricksworkspace)
