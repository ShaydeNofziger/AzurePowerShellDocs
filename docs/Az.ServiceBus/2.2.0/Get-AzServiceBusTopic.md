...
### GetViaIdentity
```
Get-AzServiceBusTopic -InputObject <IServiceBusIdentity> [-DefaultProfile <PSObject>] [-Break]
...
[https://learn.microsoft.com/powershell/module/az.servicebus/get-azservicebustopic](https://learn.microsoft.com/powershell/module/az.servicebus/get-azservicebustopic)
