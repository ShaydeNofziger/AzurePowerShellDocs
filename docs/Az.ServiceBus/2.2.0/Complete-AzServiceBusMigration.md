...
### CompleteViaIdentity
```
Complete-AzServiceBusMigration -InputObject <IServiceBusIdentity> [-DefaultProfile <PSObject>] [-Break]
...
[https://learn.microsoft.com/powershell/module/az.servicebus/complete-azservicebusmigration](https://learn.microsoft.com/powershell/module/az.servicebus/complete-azservicebusmigration)
