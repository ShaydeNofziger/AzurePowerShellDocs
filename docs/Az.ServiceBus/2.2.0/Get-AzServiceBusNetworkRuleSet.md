...
### GetViaIdentity
```
Get-AzServiceBusNetworkRuleSet -InputObject <IServiceBusIdentity> [-DefaultProfile <PSObject>] [-Break]
...
[https://learn.microsoft.com/powershell/module/az.servicebus/get-azservicebusnetworkruleset](https://learn.microsoft.com/powershell/module/az.servicebus/get-azservicebusnetworkruleset)
