...
### DeleteViaIdentity
```
Remove-AzServiceBusRule -InputObject <IServiceBusIdentity> [-DefaultProfile <PSObject>] [-Break]
...
[https://learn.microsoft.com/powershell/module/az.servicebus/remove-azservicebusrule](https://learn.microsoft.com/powershell/module/az.servicebus/remove-azservicebusrule)
