...
### DeleteViaIdentity
```
Remove-AzServiceBusMigration -InputObject <IServiceBusIdentity> [-DefaultProfile <PSObject>] [-Break]
...
[https://learn.microsoft.com/powershell/module/az.servicebus/remove-azservicebusmigration](https://learn.microsoft.com/powershell/module/az.servicebus/remove-azservicebusmigration)
