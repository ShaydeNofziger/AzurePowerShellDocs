...
### DeleteViaIdentity
```
Remove-AzServiceBusTopic -InputObject <IServiceBusIdentity> [-DefaultProfile <PSObject>] [-Break]
...
[https://learn.microsoft.com/powershell/module/az.servicebus/remove-azservicebustopic](https://learn.microsoft.com/powershell/module/az.servicebus/remove-azservicebustopic)
