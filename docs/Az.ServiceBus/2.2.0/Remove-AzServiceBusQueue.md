...
### DeleteViaIdentity
```
Remove-AzServiceBusQueue -InputObject <IServiceBusIdentity> [-DefaultProfile <PSObject>] [-Break]
...
[https://learn.microsoft.com/powershell/module/az.servicebus/remove-azservicebusqueue](https://learn.microsoft.com/powershell/module/az.servicebus/remove-azservicebusqueue)
