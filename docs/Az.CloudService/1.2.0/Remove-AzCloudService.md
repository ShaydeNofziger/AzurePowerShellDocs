...
### DeleteViaIdentity
```
Remove-AzCloudService -InputObject <ICloudServiceIdentity> [-DefaultProfile <PSObject>] [-AsJob] [-Break]
...
[https://learn.microsoft.com/powershell/module/az.cloudservice/remove-azcloudservice](https://learn.microsoft.com/powershell/module/az.cloudservice/remove-azcloudservice)
