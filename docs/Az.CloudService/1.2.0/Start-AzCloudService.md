...
### StartViaIdentity
```
Start-AzCloudService -InputObject <ICloudServiceIdentity> [-DefaultProfile <PSObject>] [-AsJob] [-Break]
...
[https://learn.microsoft.com/powershell/module/az.cloudservice/start-azcloudservice](https://learn.microsoft.com/powershell/module/az.cloudservice/start-azcloudservice)
