...
Invoke-AzCloudServiceReimage -Name <String> -ResourceGroupName <String> [-SubscriptionId <String>]
 -RoleInstance <String[]> [-DefaultProfile <PSObject>] [-AsJob] [-Break]
...
[https://learn.microsoft.com/powershell/module/az.cloudservice/invoke-azcloudservicereimage](https://learn.microsoft.com/powershell/module/az.cloudservice/invoke-azcloudservicereimage)
