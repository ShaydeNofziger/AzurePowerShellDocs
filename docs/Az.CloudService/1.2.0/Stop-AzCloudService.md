...
### PowerOffViaIdentity
```
Stop-AzCloudService -InputObject <ICloudServiceIdentity> [-DefaultProfile <PSObject>] [-AsJob] [-Break]
...
[https://learn.microsoft.com/powershell/module/az.cloudservice/stop-azcloudservice](https://learn.microsoft.com/powershell/module/az.cloudservice/stop-azcloudservice)
