...
This will remove all the services under the application.
...
## DESCRIPTION
This cmdlet removes an application form the cluster.
This will remove all the services, if any, under the application resource.
