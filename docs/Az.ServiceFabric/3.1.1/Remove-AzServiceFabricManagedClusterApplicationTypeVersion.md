...
## SYNOPSIS
Removes a managed application type version from the cluster.
Only supports ARM deployed application type versions.
...
## DESCRIPTION
This cmdlet will remove a managed application type version from the cluster.
All applications under this resource must be removed before running this command.
...
This example will remove the managed version "v1" under the type "testAppType".
It there are any applications under this resource the command will throw an exception.
