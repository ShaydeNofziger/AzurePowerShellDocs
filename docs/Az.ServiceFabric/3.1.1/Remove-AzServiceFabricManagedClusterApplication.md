...
## SYNOPSIS
Remove an managed application from the cluster.
This will remove all the managed services under the application.
...
## DESCRIPTION
This cmdlet removes an managed application form the cluster.
This will remove all the managed services, if any, under the application resource.
