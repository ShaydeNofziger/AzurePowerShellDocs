...
## DESCRIPTION
This cmdlet will remove Service fabric an application type version from the cluster.
...
This example will remove the version "v1" under the type "testAppType".
