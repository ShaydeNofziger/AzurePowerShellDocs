...
## DESCRIPTION
Remove vm extension from the node type by name.
Use Get-AzServiceFabricManagedNodeType (./Get-AzServiceFabricManagedNodeType.md)and look at the VmExtensions property to see the current extension on the node type.
