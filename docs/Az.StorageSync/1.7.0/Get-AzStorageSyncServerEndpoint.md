...
## DESCRIPTION
This command lists all server endpoints within a given sync group.
It can be used to also list the attributes of each server endpoint.
...
This command gets all server endpoints contained within the specified sync group.
Specify -ServerEndpointName to return a specific one.
