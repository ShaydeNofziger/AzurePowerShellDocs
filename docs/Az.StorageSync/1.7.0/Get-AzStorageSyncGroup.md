...
## DESCRIPTION
This command lists all sync groups within a given storage sync service.
It can be used to also list the attributes of each sync group.
...
This command gets all sync groups contained within the specified storage sync service.
Specify -Name to return a specific one.
