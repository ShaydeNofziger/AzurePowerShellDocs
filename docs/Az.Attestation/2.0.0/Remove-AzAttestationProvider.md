...
### DeleteViaIdentity
```
Remove-AzAttestationProvider -InputObject <IAttestationIdentity> [-DefaultProfile <PSObject>] [-Break]
...
[https://docs.microsoft.com/powershell/module/az.attestation/remove-azattestationprovider](https://docs.microsoft.com/powershell/module/az.attestation/remove-azattestationprovider)
