...
The first command creates a local empty snapshot object with size 5GB in Standard_LRS storage account type. 
...
### -Incremental
Specifies an incremental snapshot.
...
### -PurchasePlan
Sets the purchase plan for the snapshot.
