...
If the file is stored in Azure Blob storage, the file name value is case-sensitive.
File names of files stored in Azure File storage are not case-sensitive.
