...
If this parameter is not specified, default value is Microsoft.Azure.Security for Windows VMs and Linux VMs
...
If the VolumeType parameter is omitted it defaults to "All".
