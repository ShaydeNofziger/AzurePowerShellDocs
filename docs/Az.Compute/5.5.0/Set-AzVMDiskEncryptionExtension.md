...
It enables encryption by installing the disk encryption extension on the virtual machine.
...
If the Name parameter is omitted, the installed extension will be named AzureDiskEncryption on Windows virtual machines and AzureDiskEncryptionForLinux on Linux virtual machines.
