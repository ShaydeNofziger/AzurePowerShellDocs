...
### -LicenseType
Specifies the software license type that will be applied to the VMs deployed on the host.
Possible values are: None, Windows_Server_Hybrid, and Windows_Server_Perpetual. 
...
### -PlatformFaultDomain
Specifies the number of platform fault domain of the host. 
Then minimum value is 0 and the maximum value is 2.
