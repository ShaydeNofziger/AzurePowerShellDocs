...
### -Permission
This property allows you to specify the permission of the sharing gallery.
Possible values are: 'Private' and 'Groups'.
...
### -PublicNamePrefix
Gets or sets the prefix of the gallery name that will be displayed publicly.
...
### -PublisherContact
Gets or sets community gallery publisher support email.
...
### -PublisherUri
Gets or sets the link to the publisher website.
Visible to all users.
