...
Disable-AzBatchComputeNodeScheduling lets you do the following:  - Terminate the tasks and put them back in the job queue.
...
The acceptable values for this parameter are: - Requeue.
