...
## DESCRIPTION
The Get-AzDeletedWebApp cmdlet returns all deleted web apps in the subscription.
Deleted apps can optionally be filtered by resource group, name, and slot.
There can be more than one deleted app with the same name and resource group.
