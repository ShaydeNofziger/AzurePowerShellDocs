...
## DESCRIPTION
The Remove-AzAppServiceEnvironment cmdlet removes an App Service Environment.
Any App Service Plan must be deleted prior to deleting the ASE.
