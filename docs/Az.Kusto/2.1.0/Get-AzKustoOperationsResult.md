...
### GetViaIdentity
```
Get-AzKustoOperationsResult -InputObject <IKustoIdentity> [-DefaultProfile <PSObject>] [-Break]
...
[https://docs.microsoft.com/powershell/module/az.kusto/get-azkustooperationsresult](https://docs.microsoft.com/powershell/module/az.kusto/get-azkustooperationsresult)
