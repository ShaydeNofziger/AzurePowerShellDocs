...
New-AzKustoCluster -Name <String> -ResourceGroupName <String> [-SubscriptionId <String>] [-IfMatch <String>]
 ...
 [-KeyVaultPropertyKeyVersion <String>] [-KeyVaultPropertyUserIdentity <String>] [-OptimizedAutoscaleIsEnabled]
 ...
 [-Zone <String[]>] [-DefaultProfile <PSObject>] [-AsJob] [-Break] [-HttpPipelineAppend <SendAsyncStep[]>]
...
[https://docs.microsoft.com/powershell/module/az.kusto/new-azkustocluster](https://docs.microsoft.com/powershell/module/az.kusto/new-azkustocluster)
