...
Test-AzKustoAttachedDatabaseConfigurationNameAvailability -ClusterName <String> -ResourceGroupName <String>
 [-SubscriptionId <String>] -Name <String> [-DefaultProfile <PSObject>] [-Break]
...
[https://docs.microsoft.com/powershell/module/az.kusto/test-azkustoattacheddatabaseconfigurationnameavailability](https://docs.microsoft.com/powershell/module/az.kusto/test-azkustoattacheddatabaseconfigurationnameavailability)
