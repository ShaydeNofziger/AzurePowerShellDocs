...
### List (Default)
```
Get-AzKustoClusterSku [-SubscriptionId <String[]>] [-DefaultProfile <PSObject>] [-Break]
...
[https://docs.microsoft.com/powershell/module/az.kusto/get-azkustoclustersku](https://docs.microsoft.com/powershell/module/az.kusto/get-azkustoclustersku)
