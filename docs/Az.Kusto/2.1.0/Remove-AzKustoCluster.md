...
### DeleteViaIdentity
```
Remove-AzKustoCluster -InputObject <IKustoIdentity> [-DefaultProfile <PSObject>] [-AsJob] [-Break]
...
[https://docs.microsoft.com/powershell/module/az.kusto/remove-azkustocluster](https://docs.microsoft.com/powershell/module/az.kusto/remove-azkustocluster)
