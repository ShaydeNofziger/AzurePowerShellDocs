...
### GetViaIdentity
```
Get-AzKustoPrivateLinkResource -InputObject <IKustoIdentity> [-DefaultProfile <PSObject>] [-Break]
...
[https://docs.microsoft.com/powershell/module/az.kusto/get-azkustoprivatelinkresource](https://docs.microsoft.com/powershell/module/az.kusto/get-azkustoprivatelinkresource)
