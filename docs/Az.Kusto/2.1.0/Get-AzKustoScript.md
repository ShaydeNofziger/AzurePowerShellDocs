...
### GetViaIdentity
```
Get-AzKustoScript -InputObject <IKustoIdentity> [-DefaultProfile <PSObject>] [-Break]
...
[https://docs.microsoft.com/powershell/module/az.kusto/get-azkustoscript](https://docs.microsoft.com/powershell/module/az.kusto/get-azkustoscript)
