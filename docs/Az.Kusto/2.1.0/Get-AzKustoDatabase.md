...
### GetViaIdentity
```
Get-AzKustoDatabase -InputObject <IKustoIdentity> [-DefaultProfile <PSObject>] [-Break]
...
[https://docs.microsoft.com/powershell/module/az.kusto/get-azkustodatabase](https://docs.microsoft.com/powershell/module/az.kusto/get-azkustodatabase)
