...
### List (Default)
```
Get-AzBillingProfile -BillingAccountName <String> [-ExpandInvoiceSection]
 [-DefaultProfile <IAzureContextContainer>] [<CommonParameters>]
```

### Single
```
Get-AzBillingProfile -Name <System.Collections.Generic.List`1[System.String]> -BillingAccountName <String>
 [-ExpandInvoiceSection] [-DefaultProfile <IAzureContextContainer>] [<CommonParameters>]
```
