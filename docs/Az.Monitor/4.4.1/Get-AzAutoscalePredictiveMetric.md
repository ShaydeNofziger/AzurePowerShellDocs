...
Get-AzAutoscalePredictiveMetric -InputObject <IAutoscaleIdentity> -Aggregation <String> -Interval <TimeSpan>
 -MetricName <String> -MetricNamespace <String> -Timespan <String> [-DefaultProfile <PSObject>] [-Break]
...
Get-AzAutoscalePredictiveMetric -AutoscaleSettingName <String> -ResourceGroupName <String>
 ...
 -MetricNamespace <String> -Timespan <String> [-DefaultProfile <PSObject>] [-Break]
 [-HttpPipelineAppend <SendAsyncStep[]>] [-HttpPipelinePrepend <SendAsyncStep[]>] [-Proxy <Uri>]
 [-ProxyCredential <PSCredential>] [-ProxyUseDefaultCredentials] [<CommonParameters>]
```
...
[https://learn.microsoft.com/powershell/module/az.monitor/get-azautoscalepredictivemetric](https://learn.microsoft.com/powershell/module/az.monitor/get-azautoscalepredictivemetric)
