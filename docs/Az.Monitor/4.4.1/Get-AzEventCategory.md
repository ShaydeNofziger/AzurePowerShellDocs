...
```
Get-AzEventCategory [-DefaultProfile <PSObject>] [-Break] [-HttpPipelineAppend <SendAsyncStep[]>]
...
[https://learn.microsoft.com/powershell/module/az.monitor/get-azeventcategory](https://learn.microsoft.com/powershell/module/az.monitor/get-azeventcategory)
