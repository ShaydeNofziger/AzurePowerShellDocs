...
## SYNOPSIS
Adds or updates a claasic metric-based alert rule (already retired on public cloud).
To create a new metric alert rule, use the Add-AzMetricAlertRuleV2 (./Add-AzMetricAlertRuleV2.md)cmdlet.
...
The acceptable values for this parameter are: - GreaterThan
...
NOTE: This property cannot be updated for an existing alert rule.
