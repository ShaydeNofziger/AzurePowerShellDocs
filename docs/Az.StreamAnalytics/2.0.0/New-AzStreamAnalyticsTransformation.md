...
New-AzStreamAnalyticsTransformation -JobName <String> -Name <String> -ResourceGroupName <String>
 ...
 [-StreamingUnit <Int32>] [-DefaultProfile <PSObject>] [-Break] [-HttpPipelineAppend <SendAsyncStep[]>]
...
[https://docs.microsoft.com/powershell/module/az.streamanalytics/new-azstreamanalyticstransformation](https://docs.microsoft.com/powershell/module/az.streamanalytics/new-azstreamanalyticstransformation)
