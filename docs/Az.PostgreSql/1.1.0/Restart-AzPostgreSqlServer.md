...
### RestartViaIdentity
```
Restart-AzPostgreSqlServer -InputObject <IPostgreSqlIdentity> [-DefaultProfile <PSObject>] [-AsJob] [-Break]
...
### EXAMPLE 2
```
/resourceGroups/PostgreSqlTestRG/providers/Microsoft.DBforPostgreSQL/servers/PostgreSqlTestServer/restart"
...
[https://docs.microsoft.com/powershell/module/az.postgresql/restart-azpostgresqlserver](https://docs.microsoft.com/powershell/module/az.postgresql/restart-azpostgresqlserver)
