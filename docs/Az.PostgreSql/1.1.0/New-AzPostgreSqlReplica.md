...
New-AzPostgreSqlReplica -ReplicaName <String> -ResourceGroupName <String> [-SubscriptionId <String>]
 -Master <IServer> [-Location <String>] [-Sku <String>] [-DefaultProfile <PSObject>] [-AsJob] [-Break]
...
[https://docs.microsoft.com/powershell/module/az.postgresql/new-azpostgresqlreplica](https://docs.microsoft.com/powershell/module/az.postgresql/new-azpostgresqlreplica)
