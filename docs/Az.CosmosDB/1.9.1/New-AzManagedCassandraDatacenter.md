...
URI to a KeyVault key used to encrypt backups of the cluster.
If omitted, Azure's own keys will be used.
...
URI of a KeyVault key used to encrypt data at rest in the cluster.
If omitted, Azure's own keys will be used.
...
### -Sku
Name of the virtual machine sku to use for nodes in this data center.
See the documentation (https://learn.microsoft.com/en-us/azure/managed-instance-apache-cassandra/create-cluster-cli)for supported skus.
