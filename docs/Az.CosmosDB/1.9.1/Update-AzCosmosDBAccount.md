...
## DESCRIPTION
Update the properties of a CosmosDB account.
...
The schema type for analytical storage.
Valid values include: 'WellDefined' and 'FullFidelity'.
...
### -BackupPolicyType
The type of backups on the Cosmos DB account.
Accepted values: Periodic, Continuous
...
### -NetworkAclBypass
Whether or not Network Acl Bypass is enabled for this account for Synapse Link.
