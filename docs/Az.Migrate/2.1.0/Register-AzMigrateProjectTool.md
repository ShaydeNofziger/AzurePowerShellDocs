...
Register-AzMigrateProjectTool -MigrateProjectName <String> -ResourceGroupName <String>
 [-SubscriptionId <String>] [-AcceptLanguage <String>] [-Tool <String>] [-DefaultProfile <PSObject>] [-Break]
...
[https://learn.microsoft.com/powershell/module/az.migrate/register-azmigrateprojecttool](https://learn.microsoft.com/powershell/module/az.migrate/register-azmigrateprojecttool)
