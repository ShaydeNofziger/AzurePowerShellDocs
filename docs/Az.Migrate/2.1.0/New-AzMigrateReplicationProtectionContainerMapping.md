...
New-AzMigrateReplicationProtectionContainerMapping -FabricName <String> -MappingName <String>
 ...
 [-TargetProtectionContainerId <String>] [-DefaultProfile <PSObject>] [-AsJob] [-Break]
...
```yaml
Type: IReplicationProviderSpecificContainerMappingInput
Parameter Sets: (All)
Aliases:
...
[https://learn.microsoft.com/powershell/module/az.migrate/new-azmigratereplicationprotectioncontainermapping](https://learn.microsoft.com/powershell/module/az.migrate/new-azmigratereplicationprotectioncontainermapping)
