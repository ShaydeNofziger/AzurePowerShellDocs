...
The role that is being assigned must be specified using the RoleDefinitionName pr RoleDefinitionId parameter.
...
This example assigns role "Managed Hsm Crypto User" to user "xxxxxxxx-xxxx-xxxx-xxxx-xxxxxxxxxxxx" at top scope.
If user wants to perform operations on keys.
