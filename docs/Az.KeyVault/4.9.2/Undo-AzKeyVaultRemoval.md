...
## DESCRIPTION
The Undo-AzKeyVaultRemoval cmdlet will recover a previously deleted key vault.
...
This command will recover the key vault 'MyKeyVault' that was previously deleted from eastus2 region and 'MyResourceGroup' resource group, into an active and usable state.
It also replaces the tags with new tag.
