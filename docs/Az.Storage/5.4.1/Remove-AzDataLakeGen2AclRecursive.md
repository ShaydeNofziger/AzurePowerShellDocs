...
This script will remove ACL rescursively on directory chunk by chunk, with chunk size as BatchSize * MaxBatchCount.
Chunk size is 50000 in this script.
...
### -ContinueOnFailure
Set this parameter to ignore failures and continue proceeing with the operation on other sub-entities of the directory.
...
If data set size exceeds MaxBatchCount multiply BatchSize, continuation token will be return.
