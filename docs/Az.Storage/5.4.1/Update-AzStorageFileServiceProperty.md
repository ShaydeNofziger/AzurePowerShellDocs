...
Enable Multichannel by set to $true, disable Multichannel by set to $false.
Applies to Premium FileStorage only.
...
### -SmbAuthenticationMethod
Gets or sets SMB authentication methods supported by server.
...
### -SmbChannelEncryption
Gets or sets SMB channel encryption supported by server.
...
### -SmbKerberosTicketEncryption
Gets or sets kerberos ticket encryption supported by server.
...
### -SmbProtocolVersion
Gets or sets SMB protocol versions supported by server.
