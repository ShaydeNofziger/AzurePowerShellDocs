...
### GetViaIdentity
```
Get-AzSentinelEntity -InputObject <ISecurityInsightsIdentity> [-DefaultProfile <PSObject>] [-Break]
...
[https://learn.microsoft.com/powershell/module/az.securityinsights/get-azsentinelentity](https://learn.microsoft.com/powershell/module/az.securityinsights/get-azsentinelentity)
