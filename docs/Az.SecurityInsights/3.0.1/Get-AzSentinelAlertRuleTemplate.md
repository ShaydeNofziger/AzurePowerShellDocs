...
### GetViaIdentity
```
Get-AzSentinelAlertRuleTemplate -InputObject <ISecurityInsightsIdentity> [-DefaultProfile <PSObject>] [-Break]
...
[https://learn.microsoft.com/powershell/module/az.securityinsights/get-azsentinelalertruletemplate](https://learn.microsoft.com/powershell/module/az.securityinsights/get-azsentinelalertruletemplate)
