...
All services created under a service topology need to be deleted before deleting the service topology.
...
Specify the service topology by its name and the resource group name.
Alternately, you can provide the ServiceTopology object or the ResourceId.
