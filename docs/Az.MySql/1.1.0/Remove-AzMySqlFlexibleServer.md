...
### DeleteViaIdentity
```
Remove-AzMySqlFlexibleServer -InputObject <IMySqlIdentity> [-DefaultProfile <PSObject>] [-AsJob] [-Break]
...
[https://docs.microsoft.com/powershell/module/az.mysql/remove-azmysqlflexibleserver](https://docs.microsoft.com/powershell/module/az.mysql/remove-azmysqlflexibleserver)
