...
### RestartViaIdentity
```
Restart-AzMySqlServer -InputObject <IMySqlIdentity> [-DefaultProfile <PSObject>] [-AsJob] [-Break]
...
### EXAMPLE 2
```
/resourceGroups/PowershellMySqlTest/providers/Microsoft.DBforMySQL/servers/mysql-test/restart"
...
[https://docs.microsoft.com/powershell/module/az.mysql/restart-azmysqlserver](https://docs.microsoft.com/powershell/module/az.mysql/restart-azmysqlserver)
