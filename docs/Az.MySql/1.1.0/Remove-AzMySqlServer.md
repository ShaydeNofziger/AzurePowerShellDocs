...
### DeleteViaIdentity
```
Remove-AzMySqlServer -InputObject <IMySqlIdentity> [-DefaultProfile <PSObject>] [-AsJob] [-Break]
...
[https://docs.microsoft.com/powershell/module/az.mysql/remove-azmysqlserver](https://docs.microsoft.com/powershell/module/az.mysql/remove-azmysqlserver)
