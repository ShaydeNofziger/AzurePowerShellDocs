...
### GetViaIdentity1
```
Get-AzCdnOriginGroup -InputObject <ICdnIdentity> [-DefaultProfile <PSObject>] [-Break]
...
[https://docs.microsoft.com/powershell/module/az.cdn/get-azcdnorigingroup](https://docs.microsoft.com/powershell/module/az.cdn/get-azcdnorigingroup)
