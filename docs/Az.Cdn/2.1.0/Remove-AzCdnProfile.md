...
### DeleteViaIdentity
```
Remove-AzCdnProfile -InputObject <ICdnIdentity> [-DefaultProfile <PSObject>] [-AsJob] [-Break]
...
[https://docs.microsoft.com/powershell/module/az.cdn/remove-azcdnprofile](https://docs.microsoft.com/powershell/module/az.cdn/remove-azcdnprofile)
