...
### DisableViaIdentity
```
Disable-AzCdnCustomDomainCustomHttps -InputObject <ICdnIdentity> [-DefaultProfile <PSObject>] [-Break]
 [-HttpPipelineAppend <SendAsyncStep[]>] [-HttpPipelinePrepend <SendAsyncStep[]>] [-PassThru] [-Proxy <Uri>]
 [-ProxyCredential <PSCredential>] [-ProxyUseDefaultCredentials] [-WhatIf] [-Confirm] [<CommonParameters>]
```
...
[https://docs.microsoft.com/powershell/module/az.cdn/disable-azcdncustomdomaincustomhttps](https://docs.microsoft.com/powershell/module/az.cdn/disable-azcdncustomdomaincustomhttps)
