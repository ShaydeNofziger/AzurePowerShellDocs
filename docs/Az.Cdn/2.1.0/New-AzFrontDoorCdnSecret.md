...
New-AzFrontDoorCdnSecret -Name <String> -ProfileName <String> -ResourceGroupName <String>
 [-SubscriptionId <String>] [-Parameter <ISecretParameters>] [-DefaultProfile <PSObject>] [-AsJob] [-Break]
...
[https://docs.microsoft.com/powershell/module/az.cdn/new-azfrontdoorcdnsecret](https://docs.microsoft.com/powershell/module/az.cdn/new-azfrontdoorcdnsecret)
