...
### GetViaIdentity
```
Get-AzFrontDoorCdnRuleSet -InputObject <ICdnIdentity> [-DefaultProfile <PSObject>] [-Break]
...
[https://docs.microsoft.com/powershell/module/az.cdn/get-azfrontdoorcdnruleset](https://docs.microsoft.com/powershell/module/az.cdn/get-azfrontdoorcdnruleset)
