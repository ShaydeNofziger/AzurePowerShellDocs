...
### GetViaIdentity
```
Get-AzFrontDoorCdnEndpoint -InputObject <ICdnIdentity> [-DefaultProfile <PSObject>] [-Break]
...
[https://docs.microsoft.com/powershell/module/az.cdn/get-azfrontdoorcdnendpoint](https://docs.microsoft.com/powershell/module/az.cdn/get-azfrontdoorcdnendpoint)
