...
### DeleteViaIdentity1
```
Remove-AzCdnOrigin -InputObject <ICdnIdentity> [-DefaultProfile <PSObject>] [-AsJob] [-Break]
 [-HttpPipelineAppend <SendAsyncStep[]>] [-HttpPipelinePrepend <SendAsyncStep[]>] [-NoWait] [-PassThru]
 [-Proxy <Uri>] [-ProxyCredential <PSCredential>] [-ProxyUseDefaultCredentials] [-WhatIf] [-Confirm]
 [<CommonParameters>]
```
...
[https://docs.microsoft.com/powershell/module/az.cdn/remove-azcdnorigin](https://docs.microsoft.com/powershell/module/az.cdn/remove-azcdnorigin)
