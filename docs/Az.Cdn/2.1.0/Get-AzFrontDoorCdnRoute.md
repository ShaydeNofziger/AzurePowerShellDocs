...
### GetViaIdentity
```
Get-AzFrontDoorCdnRoute -InputObject <ICdnIdentity> [-DefaultProfile <PSObject>] [-Break]
...
[https://docs.microsoft.com/powershell/module/az.cdn/get-azfrontdoorcdnroute](https://docs.microsoft.com/powershell/module/az.cdn/get-azfrontdoorcdnroute)
