...
### GetViaIdentity1
```
Get-AzCdnOrigin -InputObject <ICdnIdentity> [-DefaultProfile <PSObject>] [-Break]
...
[https://docs.microsoft.com/powershell/module/az.cdn/get-azcdnorigin](https://docs.microsoft.com/powershell/module/az.cdn/get-azcdnorigin)
