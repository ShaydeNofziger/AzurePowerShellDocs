...
```
Clear-AzFrontDoorCdnEndpointContent -EndpointName <String> -ProfileName <String> -ResourceGroupName <String>
 [-SubscriptionId <String>] -Content <IAfdPurgeParameters> [-DefaultProfile <PSObject>] [-AsJob] [-Break]
...
[https://docs.microsoft.com/powershell/module/az.cdn/clear-azfrontdoorcdnendpointcontent](https://docs.microsoft.com/powershell/module/az.cdn/clear-azfrontdoorcdnendpointcontent)
