...
### StartViaIdentity
```
Start-AzCdnEndpoint -InputObject <ICdnIdentity> [-DefaultProfile <PSObject>] [-AsJob] [-Break]
...
[https://docs.microsoft.com/powershell/module/az.cdn/start-azcdnendpoint](https://docs.microsoft.com/powershell/module/az.cdn/start-azcdnendpoint)
