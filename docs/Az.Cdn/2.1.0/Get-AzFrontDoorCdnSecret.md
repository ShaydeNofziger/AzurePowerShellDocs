...
### GetViaIdentity
```
Get-AzFrontDoorCdnSecret -InputObject <ICdnIdentity> [-DefaultProfile <PSObject>] [-Break]
...
[https://docs.microsoft.com/powershell/module/az.cdn/get-azfrontdoorcdnsecret](https://docs.microsoft.com/powershell/module/az.cdn/get-azfrontdoorcdnsecret)
