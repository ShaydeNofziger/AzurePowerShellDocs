...
### GetViaIdentity
```
Get-AzFrontDoorCdnCustomDomain -InputObject <ICdnIdentity> [-DefaultProfile <PSObject>] [-Break]
...
[https://docs.microsoft.com/powershell/module/az.cdn/get-azfrontdoorcdncustomdomain](https://docs.microsoft.com/powershell/module/az.cdn/get-azfrontdoorcdncustomdomain)
