...
```
Test-AzCdnNameAvailability -Name <String> -Type <ResourceType> [-DefaultProfile <PSObject>] [-Break]
...
[https://docs.microsoft.com/powershell/module/az.cdn/test-azcdnnameavailability](https://docs.microsoft.com/powershell/module/az.cdn/test-azcdnnameavailability)
