...
```
Test-AzCdnProbe [-SubscriptionId <String>] -ProbeUrl <String> [-DefaultProfile <PSObject>] [-Break]
...
[https://docs.microsoft.com/powershell/module/az.cdn/test-azcdnprobe](https://docs.microsoft.com/powershell/module/az.cdn/test-azcdnprobe)
