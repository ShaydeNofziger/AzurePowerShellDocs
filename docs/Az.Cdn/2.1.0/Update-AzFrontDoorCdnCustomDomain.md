...
Update-AzFrontDoorCdnCustomDomain -CustomDomainName <String> -ProfileName <String> -ResourceGroupName <String>
 ...
 [-TlsSetting <IAfdDomainHttpsParameters>] [-DefaultProfile <PSObject>] [-AsJob] [-Break]
...
[https://docs.microsoft.com/powershell/module/az.cdn/update-azfrontdoorcdncustomdomain](https://docs.microsoft.com/powershell/module/az.cdn/update-azfrontdoorcdncustomdomain)
