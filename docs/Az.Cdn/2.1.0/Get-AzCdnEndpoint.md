...
### GetViaIdentity1
```
Get-AzCdnEndpoint -InputObject <ICdnIdentity> [-DefaultProfile <PSObject>] [-Break]
...
[https://docs.microsoft.com/powershell/module/az.cdn/get-azcdnendpoint](https://docs.microsoft.com/powershell/module/az.cdn/get-azcdnendpoint)
