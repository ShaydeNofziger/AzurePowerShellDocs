...
New-AzCdnCustomDomain -EndpointName <String> -Name <String> -ProfileName <String> -ResourceGroupName <String>
 [-SubscriptionId <String>] [-HostName <String>] [-DefaultProfile <PSObject>] [-AsJob] [-Break]
...
[https://docs.microsoft.com/powershell/module/az.cdn/new-azcdncustomdomain](https://docs.microsoft.com/powershell/module/az.cdn/new-azcdncustomdomain)
