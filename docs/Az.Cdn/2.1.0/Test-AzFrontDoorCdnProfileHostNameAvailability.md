...
Test-AzFrontDoorCdnProfileHostNameAvailability -ProfileName <String> -ResourceGroupName <String>
 [-SubscriptionId <String>] -HostName <String> [-DefaultProfile <PSObject>] [-Break]
...
[https://docs.microsoft.com/powershell/module/az.cdn/test-azfrontdoorcdnprofilehostnameavailability](https://docs.microsoft.com/powershell/module/az.cdn/test-azfrontdoorcdnprofilehostnameavailability)
