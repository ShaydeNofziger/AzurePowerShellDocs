...
### DeleteViaIdentity
```
Remove-AzEventHubCluster -InputObject <IEventHubIdentity> [-DefaultProfile <PSObject>] [-AsJob] [-Break]
...
[https://learn.microsoft.com/powershell/module/az.eventhub/remove-azeventhubcluster](https://learn.microsoft.com/powershell/module/az.eventhub/remove-azeventhubcluster)
