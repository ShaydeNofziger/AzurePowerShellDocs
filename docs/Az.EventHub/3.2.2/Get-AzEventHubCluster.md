...
### List (Default)
```
Get-AzEventHubCluster [-SubscriptionId <String[]>] [-DefaultProfile <PSObject>] [-Break]
...
### GetViaIdentity
```
Get-AzEventHubCluster -InputObject <IEventHubIdentity> [-DefaultProfile <PSObject>] [-Break]
 [-HttpPipelineAppend <SendAsyncStep[]>] [-HttpPipelinePrepend <SendAsyncStep[]>] [-Proxy <Uri>]
 [-ProxyCredential <PSCredential>] [-ProxyUseDefaultCredentials] [<CommonParameters>]
```
...
[https://learn.microsoft.com/powershell/module/az.eventhub/get-azeventhubcluster](https://learn.microsoft.com/powershell/module/az.eventhub/get-azeventhubcluster)
