...
### DeleteViaIdentity
```
Remove-AzEventHubApplicationGroup -InputObject <IEventHubIdentity> [-DefaultProfile <PSObject>] [-Break]
...
[https://learn.microsoft.com/powershell/module/az.eventhub/remove-azeventhubapplicationgroup](https://learn.microsoft.com/powershell/module/az.eventhub/remove-azeventhubapplicationgroup)
