...
### DeleteViaIdentity
```
Remove-AzEventHub -InputObject <IEventHubIdentity> [-DefaultProfile <PSObject>] [-Break]
...
[https://learn.microsoft.com/powershell/module/az.eventhub/remove-azeventhub](https://learn.microsoft.com/powershell/module/az.eventhub/remove-azeventhub)
