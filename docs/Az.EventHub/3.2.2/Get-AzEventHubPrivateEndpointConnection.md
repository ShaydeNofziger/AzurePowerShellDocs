...
### GetViaIdentity
```
Get-AzEventHubPrivateEndpointConnection -InputObject <IEventHubIdentity> [-DefaultProfile <PSObject>] [-Break]
...
[https://learn.microsoft.com/powershell/module/az.eventhub/get-azeventhubprivateendpointconnection](https://learn.microsoft.com/powershell/module/az.eventhub/get-azeventhubprivateendpointconnection)
