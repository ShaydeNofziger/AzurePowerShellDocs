...
### DeleteViaIdentity
```
Remove-AzEventHubConsumerGroup -InputObject <IEventHubIdentity> [-DefaultProfile <PSObject>] [-Break]
 [-HttpPipelineAppend <SendAsyncStep[]>] [-HttpPipelinePrepend <SendAsyncStep[]>] [-PassThru] [-Proxy <Uri>]
 [-ProxyCredential <PSCredential>] [-ProxyUseDefaultCredentials] [-WhatIf] [-Confirm] [<CommonParameters>]
```
...
[https://learn.microsoft.com/powershell/module/az.eventhub/remove-azeventhubconsumergroup](https://learn.microsoft.com/powershell/module/az.eventhub/remove-azeventhubconsumergroup)
