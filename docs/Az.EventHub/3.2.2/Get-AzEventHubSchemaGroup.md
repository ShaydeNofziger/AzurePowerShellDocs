...
### GetViaIdentity
```
Get-AzEventHubSchemaGroup -InputObject <IEventHubIdentity> [-DefaultProfile <PSObject>] [-Break]
...
[https://learn.microsoft.com/powershell/module/az.eventhub/get-azeventhubschemagroup](https://learn.microsoft.com/powershell/module/az.eventhub/get-azeventhubschemagroup)
