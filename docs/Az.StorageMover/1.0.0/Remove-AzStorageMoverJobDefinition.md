...
Remove-AzStorageMoverJobDefinition -Name <String> -ProjectName <String> -ResourceGroupName <String>
 -StorageMoverName <String> [-SubscriptionId <String>] [-DefaultProfile <PSObject>] [-AsJob] [-Break]
...
[https://learn.microsoft.com/powershell/module/az.storagemover/remove-azstoragemoverjobdefinition](https://learn.microsoft.com/powershell/module/az.storagemover/remove-azstoragemoverjobdefinition)
