...
Remove-AzStorageMover -Name <String> -ResourceGroupName <String> [-SubscriptionId <String>]
 [-DefaultProfile <PSObject>] [-Force] [-AsJob] [-Break] [-HttpPipelineAppend <SendAsyncStep[]>]
...
[https://learn.microsoft.com/powershell/module/az.storagemover/remove-azstoragemover](https://learn.microsoft.com/powershell/module/az.storagemover/remove-azstoragemover)
