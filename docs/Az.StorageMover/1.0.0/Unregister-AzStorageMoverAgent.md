...
Unregister-AzStorageMoverAgent -Name <String> -ResourceGroupName <String> -StorageMoverName <String>
 [-SubscriptionId <String>] [-DefaultProfile <PSObject>] [-Force] [-AsJob] [-Break]
...
[https://learn.microsoft.com/powershell/module/az.storagemover/unregister-azstoragemoveragent](https://learn.microsoft.com/powershell/module/az.storagemover/unregister-azstoragemoveragent)
