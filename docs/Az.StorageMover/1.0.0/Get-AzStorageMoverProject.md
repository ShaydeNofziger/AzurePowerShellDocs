...
### GetViaIdentity
```
Get-AzStorageMoverProject -InputObject <IStorageMoverIdentity> [-DefaultProfile <PSObject>] [-Break]
...
[https://learn.microsoft.com/powershell/module/az.storagemover/get-azstoragemoverproject](https://learn.microsoft.com/powershell/module/az.storagemover/get-azstoragemoverproject)
