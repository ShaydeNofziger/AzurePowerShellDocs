...
New-AzStorageMover -Name <String> -ResourceGroupName <String> [-SubscriptionId <String>]
 -StorageMover <IStorageMover> [-DefaultProfile <PSObject>] [-Break] [-HttpPipelineAppend <SendAsyncStep[]>]
...
[https://learn.microsoft.com/powershell/module/az.storagemover/new-azstoragemover](https://learn.microsoft.com/powershell/module/az.storagemover/new-azstoragemover)
