...
New-AzStorageMoverAzStorageContainerEndpoint -Name <String> -ResourceGroupName <String>
 ...
 -StorageAccountResourceId <String> [-Description <String>] [-DefaultProfile <PSObject>] [-Break]
...
[https://learn.microsoft.com/powershell/module/az.storagemover/new-azstoragemoverazstoragecontainerendpoint](https://learn.microsoft.com/powershell/module/az.storagemover/new-azstoragemoverazstoragecontainerendpoint)
