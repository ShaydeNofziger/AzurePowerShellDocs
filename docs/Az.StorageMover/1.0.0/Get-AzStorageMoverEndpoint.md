...
### GetViaIdentity
```
Get-AzStorageMoverEndpoint -InputObject <IStorageMoverIdentity> [-DefaultProfile <PSObject>] [-Break]
...
[https://learn.microsoft.com/powershell/module/az.storagemover/get-azstoragemoverendpoint](https://learn.microsoft.com/powershell/module/az.storagemover/get-azstoragemoverendpoint)
