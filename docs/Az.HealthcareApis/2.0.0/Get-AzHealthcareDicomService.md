...
### GetViaIdentity
```
Get-AzHealthcareDicomService -InputObject <IHealthcareApisIdentity> [-DefaultProfile <PSObject>] [-Break]
...
[https://docs.microsoft.com/powershell/module/az.healthcareapis/get-azhealthcaredicomservice](https://docs.microsoft.com/powershell/module/az.healthcareapis/get-azhealthcaredicomservice)
