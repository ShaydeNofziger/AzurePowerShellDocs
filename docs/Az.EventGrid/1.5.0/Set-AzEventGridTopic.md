...
## DESCRIPTION
Sets the properties of an Event Grid topic.
This can be used to replace the tags of an Event Grid topic.
...
### -InboundIpRule
Hashtable which represents list of inbound IP rules.
...
Parameter Sets: TopicNameParameterSet, ResourceIdEventSubscriptionParameterSet
Aliases:
Accepted values: enabled, disabled, enabled, disabled, enabled, disabled, enabled, disabled
