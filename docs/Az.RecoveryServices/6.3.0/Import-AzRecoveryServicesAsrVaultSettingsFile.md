...
## DESCRIPTION
The Import-AzRecoveryServicesAsrVaultSettingsFile cmdlet imports the Azure Site Recovery vault settings file.
The vault settings file is used to set the vault context for subsequent Azure Site Recovery operations in the current session.
