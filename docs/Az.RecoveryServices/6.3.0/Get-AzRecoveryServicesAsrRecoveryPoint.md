...
The list is in order from latest to oldest Recovery Points, the first one being the Latest Processed (lowest RTO).
...
$RecoveryPoints\[0\] will have the Latest Processed Recovery Point (for Lowest RTO).
