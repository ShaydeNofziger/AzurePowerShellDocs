...
### List (Default)
```
Get-AzDataProtectionJob -ResourceGroupName <String> [-SubscriptionId <String[]>] -VaultName <String>
...
### Get
```
Get-AzDataProtectionJob -Id <String> -ResourceGroupName <String> [-SubscriptionId <String[]>]
...
### GetViaIdentity
```
Get-AzDataProtectionJob -InputObject <IDataProtectionIdentity> [-DefaultProfile <PSObject>] [-Break]
...
[https://learn.microsoft.com/powershell/module/az.dataprotection/get-azdataprotectionjob](https://learn.microsoft.com/powershell/module/az.dataprotection/get-azdataprotectionjob)
