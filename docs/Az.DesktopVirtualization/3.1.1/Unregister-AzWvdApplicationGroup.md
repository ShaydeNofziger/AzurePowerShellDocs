...
Unregister-AzWvdApplicationGroup -ResourceGroupName <String> -WorkspaceName <String>
 -ApplicationGroupPath <String> [-SubscriptionId <String>] [-DefaultProfile <PSObject>] [-Break]
...
[https://docs.microsoft.com/powershell/module/az.desktopvirtualization/unregister-azwvdapplicationgroup](https://docs.microsoft.com/powershell/module/az.desktopvirtualization/unregister-azwvdapplicationgroup)
