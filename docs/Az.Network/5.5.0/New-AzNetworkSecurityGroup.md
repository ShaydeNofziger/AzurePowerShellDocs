...
Step:1 Create a security rule allowing access from the Internet to port 3389.\<br\> Step:2 Create a security rule allowing access from the Internet to port 80.\<br\> Step:3 Add the rules created above to a new NSG named NSG-FrontEnd.\<br\>
