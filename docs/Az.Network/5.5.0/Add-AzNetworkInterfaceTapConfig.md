...
## DESCRIPTION
The Add-AzNetworkInterfaceTapConfig cmdlet creates a TapConfiguration resource associated to a NetworkInterface.
This will reference to an existing VirtualNetworkTap resource.
...
Add the TapConfiguration to a sourceNic.
The traffic from sourceNic VM will be mirrored to destination VM referred in vVirtualNetworkTap resource.
