...
## DESCRIPTION
The Get-AzAvailableServiceDelegation cmdlet allows you to retrieve all of the available service delegations for a subnet in the provided location.
This cmdlet does not describe which delegations may co-exist on a single subnet.
