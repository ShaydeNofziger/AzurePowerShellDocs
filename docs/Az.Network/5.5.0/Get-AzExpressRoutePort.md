...
## DESCRIPTION
The Get-AzExpressRoutePort cmdlet is used to retrieve an ExpressRoutePort object from your subscription.
The expressrouteport object returned can be used as input to other cmdlets that operate on ExpressRoutePort.
