...
## DESCRIPTION
The Remove-AzExpressRoutePortIdentity cmdlet removes identity from a local Azure ExpressRoutePort object.
Use Remove-AzExpressRoutePort to remove it to from ExpressRoutePort.
