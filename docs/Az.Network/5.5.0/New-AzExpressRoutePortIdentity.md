...
## DESCRIPTION
The New-AzExpressRoutePortIdentity cmdlet creates a local Azure ExpressRoutePort Identity object.
Use New-AzExpressRoutePort or Set-AzExpressRoutePort to assign it to Azure ExpressRoutePort.
