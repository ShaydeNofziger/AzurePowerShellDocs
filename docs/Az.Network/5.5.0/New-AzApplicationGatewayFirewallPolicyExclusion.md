...
This command creates a new exclusion-entry for the variable named RequestHeaderNames and operator named StartsWith and Selector named xyz.
The exclusion entry is saved in $exclusionEntry.
...
This command creates a new exclusion-entry for the variable named RequestHeaderKeys and operator named Contains and Selector named abc.
The exclusion entry is saved in $exclusionEntry.
...
This command creates a new exclusion-entry for the variable named RequestHeaderNames and operator named StartsWith, Selector named xyz and ExclusionManagedRuleSet named $exclusionManagedRuleSet.
The exclusion entry is saved in $exclusionEntry.
