...
### -Location
Specifies a location for the private endpoint.
Use Get-AzLocation (/powershell/module/az.resources/get-azlocation)to determine valid values for this parameter.
