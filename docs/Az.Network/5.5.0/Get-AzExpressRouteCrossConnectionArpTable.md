...
## DESCRIPTION
The Get-AzExpressRouteCrossConnectionARPTable cmdlet retrieves the ARP table from both interfaces of an ExpressRoute cross connection.
The ARP table provides a mapping of the IPv4 address to MAC address for a particular peering.
