...
Creates a RuleGroupOverride entry with group name as $ruleName and Rules as $rule1, $rule2.
Assigns the same to $overrideEntry
...
```yaml
Type: PSApplicationGatewayFirewallPolicyManagedRuleOverride[]
Parameter Sets: (All)
Aliases:
