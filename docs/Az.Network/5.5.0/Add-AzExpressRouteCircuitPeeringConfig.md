...
Note that, after running Add-AzExpressRouteCircuitPeeringConfig , you must call the Set-AzExpressRouteCircuit cmdlet to activate the configuration.
...
### -ExpressRouteCircuit
The ExpressRoute circuit being modified.
This is Azure object returned by the Get-AzExpressRouteCircuit cmdlet.
...
### -PeerASN
The AS number of your ExpressRoute circuit.
