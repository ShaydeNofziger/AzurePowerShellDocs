...
This example creates two new subnet configurations using the      New-AzVirtualSubnetConfig cmdlet, and then uses them to create a virtual network. 
The New-AzVirtualSubnetConfig template only creates an in-memory representation of      the subnet.
