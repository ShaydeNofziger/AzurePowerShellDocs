...
## DESCRIPTION
The Get-AzDataBoxEdgeStorageContainer cmdlet gets the storage container for an Edge Storage account on a Data Box Edge device.
You can specify the name as a parameter in the cmdlet to fetch the details of a specific storage container.
