...
## DESCRIPTION
The Get-AzDataBoxEdgeUser cmdlet lists the users configured for a Data Box Edge device.
You can mention the Name in parameters to get details about a specific user.
