...
## DESCRIPTION
The Remove-AzDataBoxEdgeStorageAccount cmdlet removes an associated Edge Storage Account for a Data Box Edge device.
You can specify the name of the Edge Storage Account to be removed as a parameter in the cmdlet.
