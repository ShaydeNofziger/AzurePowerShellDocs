...
## DESCRIPTION
The Get-AzDataBoxEdgeRole cmdlet fetches the available IoT roles for a Data Box Edge device.
You can mention the Name parameter to get the details of a specific IoT role.
