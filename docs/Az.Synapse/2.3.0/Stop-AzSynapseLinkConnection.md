...
## DESCRIPTION
The Stop-AzSynapseLinkConnection cmdlet stops a link connection in workspace.
It will cost some time from running to stopped, after calling this cmdlet you can check the detail status by calling Get-AzSynapseLinkConnectionDetailedStatus .
