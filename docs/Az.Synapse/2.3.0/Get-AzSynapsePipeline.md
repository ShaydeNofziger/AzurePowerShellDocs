...
## DESCRIPTION
The Get-AzSynapsePipeline cmdlet gets information about pipelines in workspace.
If you specify the name of a pipeline, this cmdlet gets information about that pipeline.
If you do not specify a name, this cmdlet gets information about all the pipelines in the workspace.
