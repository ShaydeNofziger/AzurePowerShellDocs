...
### -DeletionDate
The deletion date of the Azure Synaspe SQL Database to retrieve backups for, with millisecond precision (e.g.
...
### -StorageAccountType
The storage account type used to store backups for the sql pool.
