...
## DESCRIPTION
The Get-AzSynapseTriggerSubscriptionStatus cmdlet gets the status of the subscription for the event trigger to the specified external service events.
The trigger can't be started until the returned status is "Enabled".
