...
## DESCRIPTION
The Start-AzSynapseLinkConnection cmdlet starts a link connection in workspace.
It will cost some time from starting to running, after calling this cmdlet you can check the detail status by calling Get-AzSynapseLinkConnectionDetailedStatus .
