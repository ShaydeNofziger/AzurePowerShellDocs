...
Add data flow package into debug session "3afb278e-ac5f-469f-a0b6-2f04c3ab59bc" under Synapse workspace "ContosoWorkspace".
...
\[-SessionId\] parameter is optional, if it is specified, it will replace the existing sessionId property in the package file.
