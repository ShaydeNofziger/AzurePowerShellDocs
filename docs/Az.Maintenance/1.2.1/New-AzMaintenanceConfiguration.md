...
New-AzMaintenanceConfiguration [-ResourceGroupName] <String> [-Name] <String> [-Location] <String>
 ...
 [-WindowParameterExcludeKbRequiringReboot <Boolean>] [-PreTask <String>] [-PostTask <String>]
 [-InstallPatchRebootSetting <String>] [-AsJob] [-DefaultProfile <IAzureContextContainer>] [-WhatIf] [-Confirm]
 [<CommonParameters>]
```
...
Install Patch Reboot Option.
Allowed values Never, IfRequired, Always
...
### -PreTask
List of tasks executed before schedule.
e.g.
...
### -PostTask
List of tasks executed after schedule.
e.g.
\[{'source' :'runbook', 'taskScope': 'Resource', 'parameters': { 'arg1': 'value1'}}\]
