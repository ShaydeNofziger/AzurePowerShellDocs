...
ACCEPTEDSENDER \<IMicrosoftGraphDirectoryObject\[\]\>: The list of users or groups that are allowed to create post's or calendar events in this group.
If this list is non-empty then only users or groups listed here are allowed to post.
...
[https://learn.microsoft.com/powershell/module/az.resources/new-azadgroup](https://learn.microsoft.com/powershell/module/az.resources/new-azadgroup)
