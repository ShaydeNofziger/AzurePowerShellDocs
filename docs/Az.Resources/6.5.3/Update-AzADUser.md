...
Supports $filter (eq, ne, not, ge, le, startsWith, and eq on null values).
  ...
  \[PasswordPolicy \<String\>\]: Specifies password policies for the user.
This value is an enumeration with one possible value being DisableStrongPassword, which allows weaker passwords than the default policy to be specified.
DisablePasswordExpiration can also be specified.
The two may be specified together; for example: DisablePasswordExpiration, DisableStrongPassword.Supports $filter (ne, NOT).
...
NOTE:  For Azure B2C tenants, set to false and instead use custom policies and user flows to force password reset at first sign in.
...
By default, a strong password is required.
  \[PhysicalId \<String\[\]\>\]: For internal use only.
Not nullable.
...
[https://learn.microsoft.com/powershell/module/az.resources/update-azaduser](https://learn.microsoft.com/powershell/module/az.resources/update-azaduser)
