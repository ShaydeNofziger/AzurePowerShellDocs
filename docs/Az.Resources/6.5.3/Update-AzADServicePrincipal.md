...
KEYCREDENTIAL \<IMicrosoftGraphKeyCredential\[\]\>: The collection of key credentials associated with the application.
Not nullable.
Supports $filter (eq, NOT, ge, le).
To construct, see NOTES section for KEYCREDENTIALS properties and create a hash table.
  \[CustomKeyIdentifier \<Byte\[\]\>\]: Custom key identifier
...
PASSWORDCREDENTIAL \<IMicrosoftGraphPasswordCredential\[\]\>: The collection of password credentials associated with the application.
Not nullable.
To construct, see NOTES section for PASSWORDCREDENTIALS properties and create a hash table.
  \[CustomKeyIdentifier \<Byte\[\]\>\]: Do not use.
  \[DisplayName \<String\>\]: Friendly name for the password.
...
[https://learn.microsoft.com/powershell/module/az.resources/update-azadserviceprincipal](https://learn.microsoft.com/powershell/module/az.resources/update-azadserviceprincipal)
