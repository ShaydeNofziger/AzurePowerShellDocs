...
Update-AzADAppFederatedCredential -ApplicationObjectId <String> -FederatedCredentialId <String>
 ...
 [-Subject <String>] [-DefaultProfile <PSObject>] [-Break] [-HttpPipelineAppend <SendAsyncStep[]>]
...
[https://learn.microsoft.com/powershell/module/az.resources/update-azadappfederatedcredential](https://learn.microsoft.com/powershell/module/az.resources/update-azadappfederatedcredential)
