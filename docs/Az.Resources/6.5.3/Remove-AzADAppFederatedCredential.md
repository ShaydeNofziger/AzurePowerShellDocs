...
Remove-AzADAppFederatedCredential -ApplicationObjectId <String> -FederatedCredentialId <String>
 [-IfMatch <String>] [-DefaultProfile <PSObject>] [-Break] [-HttpPipelineAppend <SendAsyncStep[]>]
...
[https://learn.microsoft.com/powershell/module/az.resources/remove-azadappfederatedcredential](https://learn.microsoft.com/powershell/module/az.resources/remove-azadappfederatedcredential)
