...
The scope of the deny assignment can be specified using one of the following parameter combinations         a.
...
### -Id
Deny assignment fully qualified ID or GUID.
When Id is provided as a GUID, will take current subscription as default scope.
