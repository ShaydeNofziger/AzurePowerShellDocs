...
For instance, if the extension resource is a database, specify the following type: \`Microsoft.Sql/Servers/Databases\`
...
To determine which locations support each resource type, use the Get-AzLocation cmdlet.
