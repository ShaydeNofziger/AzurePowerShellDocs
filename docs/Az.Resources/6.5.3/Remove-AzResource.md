...
For instance, to specify a database, use the following format: server name\`/\`database name
...
For instance: \`Microsoft.Sql/Servers/Databases\`
...
The ID includes the subscription, as in the following example: \`/subscriptions/\`subscription ID\`/providers/Microsoft.Sql/servers/ContosoServer/databases/ContosoDatabase\`
...
For instance, to specify a database, use the following format: \`ContosoServer/ContosoDatabase\`
...
For instance, for a database, the resource type is as follows: \`Microsoft.Sql/Servers/Databases\`
