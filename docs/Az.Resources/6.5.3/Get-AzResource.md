...
### -Name
The name of the resource(s) to be retrieved.
...
### -ResourceGroupName
The resource group the resource(s) that is retrieved belongs in.
This parameter supports wildcards at the beginning and/or end of the string.
...
### -ResourceType
The resource type of the resource(s) to be retrieved.
...
### -Tag
Gets resources that have the specified Azure tag.
Enter a hash table with a Name key or Name and Value keys.
Wildcard characters are not supported.A "tag" is a name-value pair that you can apply to resources and resource groups.
...
To add a tag to a resource, use the Tag parameter of the New-AzResource or Set-AzResource cmdlets.
