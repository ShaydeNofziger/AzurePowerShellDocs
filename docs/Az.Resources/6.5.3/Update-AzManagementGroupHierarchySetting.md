...
Requiring Authorization and setting the DefaultManagementGroup that new groups get created under can be updated.
...
### -Authorization
Indicate whether RBAC access is required upon group creation under the root Management Group.
True means user will require Microsoft.Management/managementGroups/write action on the root Management Group.
