...
The acceptable values for this parameter are: - RequestContent
...
The acceptable values for this parameter are: - Complete: In complete mode, Resource Manager deletes resources that exist in the resource group but are not specified in the template.
...
### -TemplateFile
Specifies the full path of a custom template file.
...
When using TemplateParameterUri any dynamic parameters that you use are disregarded.
To use dynamic parameters you must instead use the TemplateParameterFile parameter
