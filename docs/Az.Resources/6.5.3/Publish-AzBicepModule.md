...
## DESCRIPTION
The Publish-AzBicepModule cmdlet publishes a Bicep file to a registry as a module.
To use the cmdlet, Bicep CLI (version 0.4.1008 or later) must be installed and added to PATH.
...
### -PassThru
Indicates that this cmdlet returns a boolean result.
