...
Add-AzADAppPermission -ApiId <Guid> -PermissionId <String> -ObjectId <Guid> [-Type <String>] [-Break]
 ...
 [-ProxyCredential <PSCredential>] [-ProxyUseDefaultCredentials] [-DefaultProfile <PSObject>] [-WhatIf]
...
[https://learn.microsoft.com/powershell/module/az.resources/add-azadapppermission](https://learn.microsoft.com/powershell/module/az.resources/add-azadapppermission)
