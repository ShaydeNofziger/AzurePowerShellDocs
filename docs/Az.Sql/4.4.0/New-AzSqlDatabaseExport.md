...
\> \[!IMPORTANT\] \> In order to make use of this cmdlet the firewall on the Azure SQL Server will need to be configured to "Allow Azure services and resources to access this server".
If this is not configured then GatewayTimeout errors will be experienced.
...
The acceptable values for this parameter are: - Sql.
SQL authentication.
...
The acceptable values for this parameter are: - StorageAccessKey.
