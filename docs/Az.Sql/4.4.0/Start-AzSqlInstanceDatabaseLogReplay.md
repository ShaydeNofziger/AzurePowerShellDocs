...
Starts a Log Replay service with container identity specified as ManagedIdentity.
In this case there is no need to specify StorageContainerSasToken parameter.
...
Starts a Log Replay service with container identity specified as SharedAccessSignature.
StorageContainerSasToken parameter is required.
