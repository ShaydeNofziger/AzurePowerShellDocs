...
New-AzSqlDatabase -DatabaseName <String> [-CollationName <String>] [-CatalogCollation <String>]
 ...
 [-UserAssignedIdentityId <String[]>] [-KeyList <String[]>] [-FederatedClientId <Guid>] [-ServerName] <String>
...
### -EnableLedger
Creates a ledger database, in which the integrity of all data is protected by the ledger feature.
...
### -Tags
Specifies a dictionary of Key-value pairs in the form of a hash table that this cmdlet associates with the new database.
