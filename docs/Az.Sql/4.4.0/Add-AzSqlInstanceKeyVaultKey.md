...
## DESCRIPTION
The Add-AzSqlInstanceKeyVaultKey cmdlet adds a key vault key to the provided Managed Instance.
The managed instance must have 'get, wrapKey, unwrapKey' permissions to the vault, use the following script to grant permission to the managed instance.
