...
## DESCRIPTION
The Get-AzSqlInstanceLink cmdlet returns information about one or more instance of Azure SQL Managed Instance links.
Specify the name of a link to see information for that link only.
