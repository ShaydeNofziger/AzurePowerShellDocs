...
### SignViaIdentity
```
Invoke-AzMarketplaceSignTerms -InputObject <IMarketplaceOrderingIdentity> [-DefaultProfile <PSObject>] [-Break]
...
[https://docs.microsoft.com/powershell/module/az.marketplaceordering/invoke-azmarketplacesignterms](https://docs.microsoft.com/powershell/module/az.marketplaceordering/invoke-azmarketplacesignterms)
