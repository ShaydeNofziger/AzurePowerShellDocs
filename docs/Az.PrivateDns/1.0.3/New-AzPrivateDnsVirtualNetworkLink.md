...
```
New-AzPrivateDnsVirtualNetworkLink -ResourceGroupName <String> -ZoneName <String> -Name <String>
 -VirtualNetwork <IVirtualNetwork> [-EnableRegistration] [-Tag <Hashtable>]
...
## DESCRIPTION
The New-AzPrivateDnsVirtualNetworkLink cmdlet creates a new private Domain Name System (DNS) virtual network link in the specified resource group and private zone.
You must specify a unique link name for the Name parameter or the cmdlet will return an error. 
