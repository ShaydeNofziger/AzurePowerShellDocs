...
## DESCRIPTION
The \`Import-AzConfig\` cmdlet imports all the configs from a file that was previously exported by \`Export-AzConfig\`.
The imported configs will be set at the "CurrentUser" scope, so they are consistent across PowerShell sessions.
