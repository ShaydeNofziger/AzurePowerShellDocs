...
When using -ResourceUrl, please make sure the value does match current Azure environment.
...
### -ResourceUrl
Resource url for that you're requesting token, e.g.
...
### -TenantId
Optional Tenant Id.
Use tenant id of default context if not specified.
