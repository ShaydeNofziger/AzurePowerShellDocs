...
## DESCRIPTION
The \`Export-AzConfig\` cmdlet exports all the configs that are set at the "CurrentUser" scope into a file at given path in JSON format.
The file can then be imported by \`Import-AzConfig\` for example on another machine.
