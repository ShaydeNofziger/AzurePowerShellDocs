...
Logs out the account associated with the given context (named 'Work').
Because this uses the 'CurrentUser' scope, all credentials and contexts will be permanently deleted.
