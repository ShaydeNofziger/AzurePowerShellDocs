...
### DeleteViaIdentity
```
Remove-AzStackHciArcSetting -InputObject <IStackHciIdentity> [-DefaultProfile <PSObject>] [-AsJob] [-Break]
 [-HttpPipelineAppend <SendAsyncStep[]>] [-HttpPipelinePrepend <SendAsyncStep[]>] [-NoWait] [-PassThru]
 [-Proxy <Uri>] [-ProxyCredential <PSCredential>] [-ProxyUseDefaultCredentials] [-WhatIf] [-Confirm]
 [<CommonParameters>]
```
...
[https://learn.microsoft.com/powershell/module/az.stackhci/remove-azstackhciarcsetting](https://learn.microsoft.com/powershell/module/az.stackhci/remove-azstackhciarcsetting)
