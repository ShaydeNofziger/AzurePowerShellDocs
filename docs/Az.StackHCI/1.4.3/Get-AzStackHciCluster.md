...
### List (Default)
```
Get-AzStackHciCluster [-SubscriptionId <String[]>] [-DefaultProfile <PSObject>] [-Break]
...
### GetViaIdentity
```
Get-AzStackHciCluster -InputObject <IStackHciIdentity> [-DefaultProfile <PSObject>] [-Break]
 [-HttpPipelineAppend <SendAsyncStep[]>] [-HttpPipelinePrepend <SendAsyncStep[]>] [-Proxy <Uri>]
 [-ProxyCredential <PSCredential>] [-ProxyUseDefaultCredentials] [<CommonParameters>]
```
...
[https://learn.microsoft.com/powershell/module/az.stackhci/get-azstackhcicluster](https://learn.microsoft.com/powershell/module/az.stackhci/get-azstackhcicluster)
