...
### DeleteViaIdentity
```
Remove-AzStackHciCluster -InputObject <IStackHciIdentity> [-DefaultProfile <PSObject>] [-AsJob] [-Break]
...
[https://learn.microsoft.com/powershell/module/az.stackhci/remove-azstackhcicluster](https://learn.microsoft.com/powershell/module/az.stackhci/remove-azstackhcicluster)
