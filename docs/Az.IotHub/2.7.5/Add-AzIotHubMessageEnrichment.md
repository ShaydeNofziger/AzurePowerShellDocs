...
## DESCRIPTION
Add up to 10 message enrichments per IoT Hub.
These are added as application properties to messages sent to chosen endpoint(s).
...
This new enrichment is applied to "endpoint1" and "endpoint2" endpoints.
