...
## DESCRIPTION
The Get-AzDataShareDataSet cmdlet gets information about data sets added in a share in an Azure data share account.
If you specify the name of data set, this cmdlet gets information about the data set.
If you do not specify a name, this cmdlet gets information about all the data sets in a share.I
