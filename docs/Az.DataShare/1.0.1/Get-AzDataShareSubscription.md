...
## DESCRIPTION
The Get-AzDataShareSubscription cmdlet provides information about share subscription in a data share account.
If share subscription name is provided, the cmdlet gives information about the particular share subscription.
Otherwise, the cmdlet provides a list of share subscriptions in the data share account.
