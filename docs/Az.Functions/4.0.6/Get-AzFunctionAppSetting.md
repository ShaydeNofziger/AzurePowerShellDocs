...
### ByObjectInput
```
Get-AzFunctionAppSetting -InputObject <ISite> [-DefaultProfile <PSObject>] [-Break]
...
[https://docs.microsoft.com/powershell/module/az.functions/get-azfunctionappsetting](https://docs.microsoft.com/powershell/module/az.functions/get-azfunctionappsetting)
