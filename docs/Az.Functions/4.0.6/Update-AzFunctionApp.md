...
Update-AzFunctionApp [-PlanName <String>] [-Force] [-ApplicationInsightsName <String>]
 ...
 [-IdentityID <String[]>] -InputObject <ISite> [-DefaultProfile <PSObject>] [-NoWait] [-AsJob] [-Break]
...
[https://docs.microsoft.com/powershell/module/az.functions/update-azfunctionapp](https://docs.microsoft.com/powershell/module/az.functions/update-azfunctionapp)
