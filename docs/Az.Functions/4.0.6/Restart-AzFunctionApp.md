...
### ByObjectInput
```
Restart-AzFunctionApp [-Force] -InputObject <ISite> [-DefaultProfile <PSObject>] [-PassThru] [-Break]
...
[https://docs.microsoft.com/powershell/module/az.functions/restart-azfunctionapp](https://docs.microsoft.com/powershell/module/az.functions/restart-azfunctionapp)
